...
**Disclaimer #1:** I've only included talks that I saw in person. Due to space
...
**Disclaimer #2:** The talks have not been officially released yet. I'll update
this post with links to the videos once they are available. For now I've linked
to relevant tweets, slides, and blog posts. Check out the GitHub repository
[RStudioConf2020Slides](https://github.com/EmilHvitfeldt/RStudioConf2020Slides)
by [Emil Hvitfeldt](https://twitter.com/Emil_Hvitfeldt) for more resources.
