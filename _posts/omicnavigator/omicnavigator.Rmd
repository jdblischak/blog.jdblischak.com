...
![Screenshot of differential expression pane (R package version 1.6.3.3 and web app version 1.3.4)](img/differential-expression.png)
...
![Screenshot of enrichment analysis pane (R package version 1.6.3.3 and web app version 1.3.4)](img/enrichment-analysis.png)
