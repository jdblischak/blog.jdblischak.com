...
The motivation to build OmicNavigator arose from the needs of research projects
...
This makes it easier to find genes that are significantly differentially
...
available tests. This makes it is easier to find terms that are significantly
